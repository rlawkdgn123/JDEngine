...
namespace JDGameSystem {
    ...
    using UnitCounts = JDGlobal::Contents::UnitCounts;
    ...
    public:
        ...
        const std::array<UnitTypeData, 2>& GetUnitTypes() const { return m_unitTypes; }
    ...
    private:
        std::array<UnitTypeData, 2> m_unitTypes; // 병종 정보 저장용.
