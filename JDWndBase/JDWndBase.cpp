...
LRESULT CALLBACK Window::JDWndProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
...
bool Window::JDWndBase::Create(const wchar_t* className, const wchar_t* windowName, int width, int height)
{
...
void Window::JDWndBase::OnResize(int width, int height)
{
	// 지정값으로 윈도우 사이즈 재조정
	m_width = width;
	m_height = height;
